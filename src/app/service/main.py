...
from app.service.entities import CSharpFile
...
class CSharpService:
    ...
    @classmethod
    def _compile(cls, file: CSharpFile) -> Optional[str]:

        """ Компилирует код программы """
        try:
            proc = subprocess.Popen(
                args=['mono-csc', file.filepath_csharp, f'-out:{file.filepath_out}'],
